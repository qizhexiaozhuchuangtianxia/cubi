(function(root, factory) {
    ...
    echarts.registerMap('china', {
        ...
        "features": [{
            ...
            "properties": { "cp": [115.502461, 39.045474], "name": "河北", "childNum": 3 }
        }, {
            "id": "140000",
            "geometry": {
                "type": "Polygon",
            ...
            "properties": { "cp": [123.429096, 41.5], "name": "辽宁", "childNum": 16 }
        }, {
            "id": "220000",
            "geometry": {
                "type": "Polygon",
            ...
            "properties": { "cp": [120.153576, 29.287459], "name": "浙江", "childNum": 43 }
        }, {
            "id": "340000",
            "geometry": {
                "type": "MultiPolygon",
            ...
            "properties": { "cp": [118.000923, 36.675807], "name": "山东", "childNum": 13 }
        }, {
            "id": "410000",
            "geometry": {
                "type": "MultiPolygon",
            ...
            "properties": { "cp": [113.665412, 33.5], "name": "河南", "childNum": 2 }
        }, {
            "id": "420000",
            "geometry": {
                "type": "MultiPolygon",
            ...
            "properties": { "cp": [112.298572, 31.584355], "name": "湖北", "childNum": 3 }
        }, {
            "id": "430000",
            "geometry": {
                "type": "MultiPolygon",
            ...
            "properties": { "cp": [111.982279, 28.19409], "name": "湖南", "childNum": 3 }
        }, {
            "id": "440000",
            "geometry": {
                "type": "MultiPolygon",
            ...
            "properties": { "cp": [113.280637, 22.5], "name": "广东", "childNum": 24 }
        }, {
            "id": "450000",
            "geometry": {
                "type": "MultiPolygon",
            ...
            "properties": { "cp": [102.065735, 30.659462], "name": "四川", "childNum": 2 }
        }, {
            "id": "520000",
            "geometry": {
                "type": "MultiPolygon",
            ...
            "properties": { "cp": [101.712251, 24.040609], "name": "云南", "childNum": 1 }
        }, {
            "id": "540000",
            "geometry": {
                "type": "Polygon",
            ...
            "properties": { "cp": [108.4, 34.263161], "name": "陕西", "childNum": 1 }
        }, {
            "id": "620000",
            "geometry": {
                "type": "MultiPolygon",
            ...
            "properties": { "cp": [98, 40.058039], "name": "甘肃", "childNum": 3 }
        }, {
            "id": "630000",
            "geometry": {
                "type": "MultiPolygon",
            ...
            "properties": { "cp": [106.278179, 37.46637], "name": "宁夏", "childNum": 1 }
        }, {
            "id": "650000",
            "geometry": {
                "type": "Polygon",
