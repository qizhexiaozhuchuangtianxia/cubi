...
if($.data(e.data.target,"draggable").options.proxyOrther){
_34+=$(e.data.parent).offset().left;
top+=$(e.data.parent).offset().top;
}else{
_34+=$(e.data.parent).scrollLeft();
top+=$(e.data.parent).scrollTop();
}
...
if(_3b.proxy=="clone"){
if($.data(e.data.target,"draggable").options.proxyOrther){
	_3e=$(e.data.target).clone().appendTo($("#proxy"));
}else{
...
//top=e.data.startTop;
if($.data(e.data.target,"draggable").options.proxyOrther){
_48=$(e.data.target).offset().left;
top=$(e.data.target).offset().top;
}else{
_48=e.data.startLeft;
top=e.data.startTop;	
}
...
if(!opts.herf){
	if(opts.data){
		$("#"+opts.id).append(opts.data);
		opts.callback.call(win);
	}
}
win.show();
$(_285).window("resize");
...
$("<a></a>").attr("href","javascript:void(0)").text(_29d).bind("click",eval(_29c[_29d])).appendTo(tb).linkbutton();
}
}
...
function _299_1(_29a,_29b,_29c){
var win=$("<div class=\"messager-body\"></div>").appendTo("body");
win.append(_29b);
if(_29c){
var tb=$("<div class=\"messager-button\"></div>").appendTo(win);
for(var _29d in _29c){
$("<a class='"+_29c[_29d].cls+"'></a>").attr("href","javascript:void(0)").text(_29c[_29d].text).bind("click",eval(_29c[_29d].fn)).appendTo(tb).linkbutton();
}
}
win.window({title:_29a,noheader:(_29a?false:true),width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,onClose:function(){
setTimeout(function(){
...
//var _2a0="<div class=\""+cls+"\"></div>"+"<div class=\"msgContent\">"+msg+"</div>"+"<div style=\"clear:both;\"/>";
var _2a0="<div class=\"msgContent\">"+msg+"</div>"+"<div style=\"clear:both;\"/>";
var _2a1={};
...
var win=_299(_29f,_2a0);
return win;
},confirm:function(_2a2,msg,fn){
//var _2a3="<div class=\"messager-icon messager-question\"></div>"+"<div>"+msg+"</div>"+"<div style=\"clear:both;\"/>";
var _2a3="<div class=\"msgContent\">"+msg+"</div>"+"<div style=\"clear:both;\"/>";
var _2a4={};
_2a4[$.messager.defaults.ok]={fn:function(){
win.window("close");
if(fn){
fn(true);
return false;
...
var clone = p.panel("panel").find('.'+p.panel("options").menuCls).clone(true);
if(!_3a6[_3a8]){
_3a6[_3a8]=_3a9(_3a4);
if(p.panel("options").menu){
_3a6[_3a8].panel("panel").addClass(p.panel("options").addMenuCls);
_3a6[_3a8].panel("panel").find('.panel-body').html(clone);
_3a6[_3a8].panel("panel").find('.panel-body').find('.tree-node').each(function(e){
$(this).mousedown(function(){
_3a6[_3a8].panel("panel").find('.panel-body').find('.tree-node-selected').removeClass('tree-node-selected');
setTimeout(function(){
p.panel("panel").find('.'+p.panel("options").menuCls).find('.tree-node').removeClass('tree-node-selected');
p.panel("panel").find('.'+p.panel("options").menuCls).find('.tree-node').eq(e).addClass('tree-node-selected');
},300)
})
})	
}
...
opts.onSelect.call(_50c,opts.current,t.closest("div.calendar-body"),t);
...
data.push("<td class=\""+cls+"\" abbr=\""+s+"\" style=\""+_52d+"\"><span><em>"+d+"</em></span></td>");
}
data.push("</tr>");
}
data.push("</tbody>");
...
if(opts.hideHead){
var _5bb=$("<div class=\"datagrid-wrap\">"+"<div class=\"datagrid-view\">"+"<div class=\"datagrid-view1\">"+"<div class=\"datagrid-body\">"+"<div class=\"datagrid-body-inner\"></div>"+"</div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"<div class=\"datagrid-view2\">"+"<div class=\"datagrid-body\"></div>"+"<div style=\"display:none\" class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div style=\"display:none\" class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"</div>"+"</div>").insertAfter(_5b6);
}else{
...
var _6dd=_5b5(this,opts.rownumbers,opts);
if(!opts.columns){
...
_9cf(this,q);
}},/*currentText:"今天",*/clearText:"清除",closeText:"关闭",okText:"Ok",buttons:[/*{text:function(_9e4){
...
return $(_9e4).datebox("options").clearText;
},handler:function(_9e5){
$(_9e5).datebox("setValue",' ');
$(_9e5).datebox("options").onSelect.call(this,'')
...
$.replaceStr = function(str){
	var RexStr = /\<|\>|\"|\'|\&/g ;
	var newStr = str.replace(RexStr,function(MatchStr) {
		switch (MatchStr) {  
		case "<":  
			return "&lt;";  
			break;  
