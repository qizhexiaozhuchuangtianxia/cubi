...
function StackChartManager() {
	EChartManager.call(this);
}

StackChartManager.prototype = _.create(EChartManager.prototype, {
	...
	handleLegendChanged: function (param) {
		...
		let options   = new SetOption(this.option, this.indexFields);
		let newOption = options.getOption();
	...
	_tooltipFormatter: function (params, ticket, callback) {
		...
		if (AXIS === this.option.tooltip.trigger) {
			...
			return tooltipFormattedValueForStackItem(params, params.data.xAxisName);
		}
		else {
		}
	},
...
module.exports = StackChartManager;