        ...
        if(this.props.row==this.props.len-1){
         ...
         return (
            <div className="dashboardView_list">
                ...
                <AddCellLeft row={this.props.row} operation={this.props.operation} cell="0" cellLen={this.props.cells.length}/>
                <AddCellRight row={this.props.row} operation={this.props.operation} cell="0" cellLen={this.props.cells.length}/>
            <div className="dashboardView_row">
                <AddCellLeft row={this.props.row} operation={this.props.operation} cellLen={this.props.cells.length}/>
                <AddCellRight row={this.props.row} operation={this.props.operation} cellLen={this.props.cells.length}/>
