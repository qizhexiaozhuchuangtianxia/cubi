...
class SearchComponent extends Component {
	...
	componentDidMount(){
 		//重置搜索的方法
 		this.app['APP-DASHBOARD-DEFAULT-RESET-SEARCH-HANDLE'] = App.on('APP-DASHBOARD-DEFAULT-RESET-SEARCH-HANDLE',this._resetSearchHandle.bind(this));
	}
	...
	_resetSearchHandle(obj){
		...
		if(this.props.row==obj.row&&this.props.col==obj.col&&this.props.dimensionId==obj.dimensionId){
			this.setState({
				...
				App.emit('APP-DASHBOARD-DEFAULT-SEARCH-DATA-HANDLE',{
					row:_this.props.row,
					col:_this.props.col,
