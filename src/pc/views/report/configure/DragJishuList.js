...
var App = require('app');
var Item = require('./DragJishuItem');
module.exports = React.createClass({
	...
	getItems:function(item,index){
		return <Item key={item.fieldName} fieldName={item.fieldName} typeName={item.typeName} customName={item.customName} itemName={item.itemName} statistical={item.statistical} type={item.type} name={item.name}/>;	
	},
