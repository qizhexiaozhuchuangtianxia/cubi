...
var App = require('app');
var Item = require('./DragPingjunItem');
module.exports = React.createClass({
	displayName:'DragPingjunList',
	...
	getItems:function(item,index){
		return <Item key={item.fieldName} fieldName={item.fieldName} customName={item.customName} typeName={item.typeName} itemName={item.itemName} statistical={item.statistical} type={item.type} name={item.name}/>;	
	},
