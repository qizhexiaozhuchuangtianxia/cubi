...
var App = require('app');
var Item = require('./DragWeiduJushuItem');
module.exports = React.createClass({
	...
	render: function(){
		...
		return (
			<div className="zhibiao-items weidujishu">
	...
	getItems:function(item,index){
		return <Item key={item.fieldName} fieldName={item.fieldName} typeName={item.typeName} customName={item.customName} itemName={item.itemName} statistical={item.statistical} type={item.type} name={item.name} distinct={item.distinct}/>;	
	},
